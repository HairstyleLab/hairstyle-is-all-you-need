...
class HairstyleAgent:
    ...
    def _build_agent(self):
        ...
        def hairstyle_recommendation_tool(faceshape_keywords=None, gender_keywords=None, personalcolor_keywords=None, season=None, hairstyle_keywords=None, haircolor_keywords=None, hairlength_keywords=None):
            ...
            return hairstyle_recommendation(self.model, self.current_image_base64, faceshape_keywords, gender_keywords, personalcolor_keywords,season, hairstyle_keywords, haircolor_keywords, hairlength_keywords, status_callback=self.status_callback)
